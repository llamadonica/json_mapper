part of dynamic_mapper_factory;
...
class _MapDynamicMapper<K, V> implements Mapper<Map<K, V>, Map<K, dynamic>> {
  ...
  void decoder(Map<K, V> obj, Object data, FieldDecoder fieldDecoder,
    ...
    var mapper = _dynamicMapper(valueType, null);
...
class _DynamicFieldMapper<T> extends BuilderFieldMapper<T> {
  _DynamicFieldMapper(List<String> positionalArgs,
  ...
  ModelFactory<T> createModel) : super(positionalArgs, namedArgs, getters, setters, types, constructorTypes, getterFields, setterFields, constructorFields, getterMetadata, setterMetadata, constructorMetadata, createModel);

  Mapper/*<S,E>*/ createMapper/*<S,E>*/(Type type, dynamic/*=S*/ typeSentry) => _dynamicMapper/*<S,E>*/(type, typeSentry);
}
  ...
  if (mapper == null) {
    ...
    final ModelFactory<dynamic/*=T*/ > createModel = (posArgs, namedArgs) =>
        (clazz as ClassMirror)
            .newInstance(new Symbol(""), posArgs, new Map.fromIterable(namedArgs.keys, key: (k) => new Symbol(k),value: (k) => namedArgs[k]))
...
void _buildChain/*<T,E>*/(
  ...
  if (superclass != null && superclass.hasReflectedType && clazz.superclass.reflectedType != Object) {
    _buildChain/*<T,E>*/(
        null,
        null,
        getters,
    ...
    if (mirror is VariableMirror && !mirror.isStatic && !mirror.isPrivate) {
      ...
      if (mirror.isConstructor &&
        ...
        mirror.parameters.forEach((parameterMirror) {
          ...
          TypeMirror fieldType = parameterMirror.type;
          _decodeConstructor(
              fieldName,
              fieldInfo,
              metadata,
